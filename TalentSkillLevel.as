...
//Storage.TalentSkillLevel

package Storage
{
    import id.ninjasage.Util;

    public class TalentSkillLevel 
    {
        ...
        public static function constructData(_arg_1:*):*
        {
            var _local_2:*;
            var _local_3:*;
            TalentSkillLevel.data = {};
            for (_local_2 in _arg_1)
            {
                _local_3 = _arg_1[_local_2];
                TalentSkillLevel.data[_local_3.id] = _local_3;
            };
            _constructed = true;
            _arg_1 = null;
        }

        public static function getTalentSkillLevels(_arg_1:String, _arg_2:*):*
        {
            var _local_3:* = ((_arg_1 + ":") + String(_arg_2));
            if (!TalentSkillLevel.data.hasOwnProperty(_local_3))
            {
                return (false);
            };
            var _local_4:* = TalentSkillLevel.data[_local_3];
            TalentSkillLevel.mutateEffects(_local_4);
            return (_local_4);
        }

        public static function getCopy(_arg_1:*, _arg_2:*):*
        {
            var _local_3:* = TalentSkillLevel.getTalentSkillLevels(_arg_1, _arg_2);
            if (_local_3)
            {
        ...
        {
            return (TalentSkillLevel._constructed == true);
        }
