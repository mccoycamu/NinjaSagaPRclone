...
//id.ninjasage.features.ElementalArsPackage
...
package id.ninjasage.features
{
    ...
    public dynamic class ElementalArsPackage extends MovieClip 
    {

        private const packageTitle:String = "Elemental Ars Package";
        ...
        public function ElementalArsPackage(_arg_1:*, _arg_2:*)
        {
            this.main = _arg_1;
            this.panelMC = _arg_2;
        ...
        private function setRewardData():void
        {
            ...
            while (_local_2 < _local_1.length)
            {
                ...
                _local_4 = 0;
                while (_local_4 < _local_3.outfits.set.length)
                {
        ...
        private function selectPackage(_arg_1:MouseEvent=null):void
        {
            ...
            while (_local_2 < 3)
            {
                ...
                if (this.packageData[this.selectedPackage].packageOutfit.package_set[_local_2])
                {
                    this.panelMC.panelMC[("btn_set_" + _local_2)].visible = true;
                };
                _local_2++;
