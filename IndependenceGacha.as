...
//id.ninjasage.features.IndependenceGacha
...
package id.ninjasage.features
{
    ...
    public dynamic class IndependenceGacha extends MovieClip 
    {

        private static const MATERIAL_GACHA:String = "material_2197";
        ...
        public function IndependenceGacha(_arg_1:*, _arg_2:*)
        {
            var _local_3:* = GameData.get("independence2025");
        ...
        private function getEventData():void
        {
            ...
            this.main.amf_manager.service("IndependenceEvent2025.getGachaData", [Character.char_id, Character.sessionkey, Character.account_id], this.eventDataResponse);
        }
        ...
        private function sendAmf():*
        {
            ...
            this.main.amf_manager.service("IndependenceEvent2025.getGachaRewards", [Character.char_id, Character.sessionkey, this.playType, this.playQty], this.getGachaRewardsRes);
        }
        ...
        private function openBonusRewards(_arg_1:MouseEvent):void
        {
            ...
            this.main.amf_manager.service("IndependenceEvent2025.getBonusGachaRewards", [Character.char_id, Character.sessionkey, Character.account_id], this.openBonusRewardsRes);
        }
        ...
        private function onClaimBonusRequest(_arg_1:MouseEvent):void
        {
            ...
            this.main.amf_manager.service("IndependenceEvent2025.claimBonusGachaRewards", [Character.char_id, Character.sessionkey, _local_2], this.onClaimBonusResponse);
        }
        ...
        private function openHistory(_arg_1:MouseEvent):void
        {
            ...
            if (_local_2 == "personalBtn")
            {
                ...
                this.main.amf_manager.service("IndependenceEvent2025.getPersonalGachaHistory", [Character.char_id, Character.sessionkey], this.historyResponse);
            }
            else
            {
                this.panelMC.historyMC.titleTxt.text = "Global Prize History";
                this.main.amf_manager.service("IndependenceEvent2025.getGlobalGachaHistory", [Character.char_id, Character.sessionkey], this.historyResponse);
            };
        }
