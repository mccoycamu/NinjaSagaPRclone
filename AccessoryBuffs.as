...
package Storage
{
    ...
    public class AccessoryBuffs extends MovieClip 
    {
        ...
        public function AccessoryBuffs(_arg_1:*)
        {
            this.main = _arg_1;
        }
        ...
        public static function constructData(_arg_1:*):*
        {
            ...
            {
                AccessoryBuffs.data[_local_2.id] = AccessoryBuffs.prefix(_local_2);
            };
            _constructed = true;
            _local_2 = null;
        }

        public static function getAccessoryBuff(_arg_1:String):*
        {
        ...
        public static function getCopy(_arg_1:*):*
        {
            var _local_3:*;
            var _local_2:* = null;
            if ((_arg_1 in AccessoryBuffs.cachedData))
            {
                _local_2 = AccessoryBuffs.cachedData[_arg_1];
            }
            else
            {
                _local_2 = JSON.parse(JSON.stringify(AccessoryBuffs.getAccessoryBuff(_arg_1)));
                AccessoryBuffs.cachedData[_arg_1] = _local_2;
            };
