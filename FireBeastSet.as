...
//id.ninjasage.features.FireBeastSet
...
package id.ninjasage.features
{
    ...
    public dynamic class FireBeastSet extends MovieClip 
    {
        ...
        public function FireBeastSet(_arg_1:*, _arg_2:*)
        {
            this.main = _arg_1;
        ...
        private function getDataResponse(_arg_1:Object):void
        {
            ...
            if (_arg_1.status == 1)
            {
                ...
                this.costumeData = _arg_1.packages.firebeast;
            }
            else
            {
        ...
        private function buyPackage(_arg_1:MouseEvent):void
        {
            ...
            this.main.loading(true);
            this.main.amf_manager.service("ExoticPackage.buy", [Character.char_id, Character.sessionkey, "firebeast"], this.buyResponse);
        }
