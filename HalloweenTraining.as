...
//id.ninjasage.features.HalloweenTraining
...
package id.ninjasage.features
{
    ...
    public dynamic class HalloweenTraining extends MovieClip 
    {
        ...
        public function HalloweenTraining(_arg_1:*, _arg_2:*)
        {
        ...
        private function buyPackage(_arg_1:MouseEvent):void
        {
            ...
            this.main.amf_manager.service("HalloweenEvent2025.buySkill", [Character.char_id, Character.sessionkey], this.buyResponse);
        }
        ...
        private function buyResponse(_arg_1:Object):void
        {
            ...
            if (_arg_1.status == 1)
            {
                this.main.giveReward(1, this.rewardData[this.selectedBuy].skillId, "halloween");
