...
//id.ninjasage.features.SummerGacha
...
package id.ninjasage.features
{
    ...
    public dynamic class SummerGacha extends MovieClip 
    {

        private static const MATERIAL_GACHA:String = "material_2195";
        ...
        public function SummerGacha(_arg_1:*, _arg_2:*)
        {
            var _local_3:* = GameData.get("summer2025");
        ...
        private function getEventData():void
        {
            ...
            this.main.amf_manager.service("SummerEvent2025.getGachaData", [Character.char_id, Character.sessionkey, Character.account_id], this.eventDataResponse);
        }
        ...
        private function sendAmf():*
        {
            ...
            this.main.amf_manager.service("SummerEvent2025.getGachaRewards", [Character.char_id, Character.sessionkey, this.playType, this.playQty], this.getGachaRewardsRes);
        }
        ...
        private function getGachaRewardsRes(_arg_1:Object):void
        {
            ...
            if (_arg_1.status == 1)
            {
                ...
                this.main.giveReward(1, _arg_1.rewards, "summer");
                this.panelMC.tokenTxt.text = String(Character.account_tokens);
        ...
        private function openBonusRewards(_arg_1:MouseEvent):void
        {
            ...
            this.main.amf_manager.service("SummerEvent2025.getBonusGachaRewards", [Character.char_id, Character.sessionkey, Character.account_id], this.openBonusRewardsRes);
        }
        ...
        private function onClaimBonusRequest(_arg_1:MouseEvent):void
        {
            ...
            this.main.amf_manager.service("SummerEvent2025.claimBonusGachaRewards", [Character.char_id, Character.sessionkey, _local_2], this.onClaimBonusResponse);
        }
        ...
        private function onClaimBonusResponse(_arg_1:Object):void
        {
            if (_arg_1.status > 0)
            {
                if (_arg_1.status == 1)
                {
                    ...
                    this.main.giveReward(1, _arg_1.reward, "summer");
                    this.panelMC.tokenTxt.text = String(Character.account_tokens);
                }
                else
                {
        ...
        private function openHistory(_arg_1:MouseEvent):void
        {
            ...
            if (_local_2 == "personalBtn")
            {
                ...
                this.main.amf_manager.service("SummerEvent2025.getPersonalGachaHistory", [Character.char_id, Character.sessionkey], this.historyResponse);
            }
            else
            {
                this.panelMC.historyMC.titleTxt.text = "Global Prize History";
                this.main.amf_manager.service("SummerEvent2025.getGlobalGachaHistory", [Character.char_id, Character.sessionkey], this.historyResponse);
            };
        }
